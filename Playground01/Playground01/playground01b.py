...
def main():
    ...
    player.volume = 80  # valor entre 0 e 100
    ...
    seg = duracao_em_segundos % 60
    print("%d:%d" % (minutos, seg))
    ...
    botao1.when_pressed = player.pause
    ...
    botao2.when_pressed = aumenta_volume
    botao3.when_pressed = diminua_volume
